    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'north'" style="width:100%;height:40%; padding:1px;border:0">
            <form method="post" id="form-penjualan">
                <table>
                    <tr>
                        <th width="30" >tanggaaaaal</th><th width="20">:</th><th width="200"> <input id="tgl" name="tgl" class="easyui-datebox"  style="width:100%;" ></th><th width="100"></th><th width="50">no bukti</th><th width="200"> <input id="tgl" name="tgl" class="easyui-textbox"  style="width:100%;" ></th>
                    </tr>  
